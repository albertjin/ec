...
func NewNode(err error, fn, info string, level int) Node {
...
func Wrap(err error, info string) Node {
    if err == nil {
        return nil
    }
...
func WrapFn(err error, fn, info string) Node {
    if err == nil {
        return nil
    }
...
func Wrapf(err error, format string, a ...interface{}) Node {
    if err == nil {
        return nil
    }
